...
RUN mkdir -p /workspace /input /output /output/roi /workspace/networks /workspace/weight\
    && chown user:user /workspace /input /output /output/roi /workspace/networks /workspace/weight
